...
using ShopNowAngular.Web.Startup;
using AngleSharp.Html.Dom;
using AngleSharp.Html.Parser;
using Microsoft.AspNetCore.Hosting;
using Shouldly;

namespace ShopNowAngular.Web.Tests
{
    public abstract class ShopNowAngularWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ShopNowAngularWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ShopNowAngularWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ShopNowAngularDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ShopNowAngularDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ShopNowAngularDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ShopNowAngularDbContext, Task<T>> func)
        {
            T result;
